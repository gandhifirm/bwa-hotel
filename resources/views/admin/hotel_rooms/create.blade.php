    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('hotel_rooms.store', $hotel->slug) }}" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="total_people" class="block w-full mt-1" type="number" name="total_people" :value="old('total_people')"/>
